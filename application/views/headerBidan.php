                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url('/admin/TransaksiController'); ?>"class="waves-effect"><i class="ti-money"></i>Diagnosa Penyakit</a>

                            </li>

                            <li class="has_sub">
                                 <a href="<?php echo base_url('/admin/LaporanController'); ?>" class="waves-effect"><i class="ti-file"></i>Resep Obat</a>
